...
TELA_LARGURA = 500
TELA_ALTURA = 700
pygame.display.set_caption("Flappy Bird - Vinicius Alochio Santos")

#criando as constantes das imagens
...
FONTE_PONTOS_fundo = pygame.font.SysFont('arial black', 55)
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    texto = FONTE_PONTOS_fundo.render(f"{pontos}", 1, (0, 0, 0))
...
def main():
    ...
    #shoot = pygame.mixer.Sound("music/coin.wav")
    rodando = True
    while rodando:
        relogio.tick(30)
